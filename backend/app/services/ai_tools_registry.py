...
TOOLS: dict[str, ToolSpec] = {t.name: t for t in (
    ...
    # --- routines / schedule ---
    ToolSpec("list_events", "List routine schedule items (optional ISO start/end range).", "calendar", "read", "LOW",
             _schema({"start": _str_prop("Range start, ISO"), "end": _str_prop("Range end, ISO")}), _h_list_events),
    ToolSpec("create_event", "Create a routine schedule item.", "calendar", "write", "LOW",
             _schema(_EVENT_FIELDS, ["title", "start_at"]), _h_create_event),
    ToolSpec("create_event_draft", "Draft a routine schedule item as a pending action.", "calendar", "write", "LOW",
             _schema(_EVENT_FIELDS, ["title", "start_at"]), _h_create_event),
    ToolSpec("create_event_after_approval", "Create a routine schedule item after human approval.", "calendar", "write", "LOW",
             _schema(_EVENT_FIELDS, ["title", "start_at"]), _h_create_event),
    ToolSpec("update_event", "Update a routine schedule item.", "calendar", "write", "LOW",
             _schema({"event_id": _str_prop("Event id"), **_EVENT_FIELDS}, ["event_id"]), _h_update_event),
    ToolSpec("update_event_after_approval", "Update a routine schedule item after human approval.", "calendar", "write", "LOW",
             _schema({"event_id": _str_prop("Event id"), **_EVENT_FIELDS}, ["event_id"]), _h_update_event),
...
_SECTION_TOOL_PRIORITIES = {
    ...
    "routines": ["list_events", "create_event_draft", "create_event"],
