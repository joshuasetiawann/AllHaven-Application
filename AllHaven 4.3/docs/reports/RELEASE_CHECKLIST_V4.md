...
— **or** paste `docs/sql/provision_me.sql` into the Supabase SQL editor (covers **0016** only).
...
- [ ] Reference: `docs/reports/WEATHER_REMOVAL_REPORT.md`
...
- [ ] Reference: `docs/TAILSCALE_SETUP.md`, `docs/reports/MOBILE_PARITY_QA.md`
...
- [ ] Reference: `docs/reports/V4_RELEASE_PLAN.md`, `docs/DOWNLOADS.md`
