...
| **⭐ AllHaven 2.9** | 2026-06-13 | **AllHaven** | `v0.17.0` | **Current.** **AI Workspace + Knowledge + finance reports** — section-aware context packets, AI Knowledge document ingestion/search/retrieval, dedicated tool-call logging, 72 allowlisted tools, configurable Drive upload limits, monthly/weekly finance reports with archived/out-of-period records, local date/time answers, direct low-risk memory saves, cleaner approval notifications, and a more direct conversational AI for coding and schedule management (migration `0008`). |
