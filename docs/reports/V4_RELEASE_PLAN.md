...
Weather is removed from active scope. The active-code grep for "weather" is **empty**; `/dashboard/weather` returns **404**. See `docs/reports/WEATHER_REMOVAL_REPORT.md`.
...
— or, for `0016` only, paste `docs/sql/provision_me.sql` into the Supabase SQL editor.
