...
// shell. The APK uses Supabase directly for core data/cloud AI and only uses the
// optional Desktop Bridge for backend-only or desktop-local services. The bridge
// URL has a build-time default (NEXT_PUBLIC_API_BASE_URL) but is also configurable
// at runtime in Settings → Backend Bridge (lib/backendUrl.ts).
